                        ...
                        <div class="ibox-content">
                            <div>
                                <div class="pull-right text-right">
                                    <small class="font-bold">Minor information</small>
                                </div>
                                <h4>Major information
                                    <br>
                                    <small class="m-r"><a href="#">Check it!</a></small>
                                </h4>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="feed-activity-list">
                                    ...
                                    <div class="feed-element">
                                        <a href="#" class="pull-left">
                                            <p>{{ image('img', 'class': 'img-profile img-circle',
                                                'src':'assets/dashboard/img/user-profile.png') }}</p>
                                        </a>

                                        <div class="media-body ">
                                            <small class="pull-right">5m ago</small>
                                            <strong>Sub-Reddit 1</strong> posted a new feed <br>
                            ...
                            <div class="timelnie-item">
                                <div class="row">
                                    ...
                                    <div class="col-xs-7 content">
                                        <p class="m-b-xs"><strong>Send documents</strong></p>
